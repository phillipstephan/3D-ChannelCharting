...
We ran our Channel Charting experiments on a JupyterHub server with NVMe storage, an AMD EPYC 7262 8-Core Processor, 64 GB RAM, and an NVIDIA GeForce RTX 4080 GPU to accelerate TensorFlow.
